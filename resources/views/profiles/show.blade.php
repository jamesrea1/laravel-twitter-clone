<x-app>
    <header class="mb-10">
        <div class="relative mb-3">
            ...
            <img src="{{ $user->avatar }}" class="rounded-full ring-4 ring-white absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2" alt="{{ $user->username }}" width="150" height="150">
        </div>

<div class="" style="width:275px;">
    <div class="fixed top-0 h-full" style="width:275px;">
        <div class="flex flex-col items-stretch h-full justify-between px-3 py-0.5">
            ...
            <div class="">
                ...
                <div class="mt-6">
                    <button class="block w-11/12 p-3 rounded-full shadow bg-twitter text-white font-bold hover:bg-opacity-80">
                        Tweet
                    </button>
                </div>
            </div>

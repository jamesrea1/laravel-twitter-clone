        ...
        <div class="flex">
            <div class="mr-3 flex-shrink-0">
                <a href="{{ current_user()->path() }}" class="block w-12 h-12 rounded-full overflow-hidden"> 
                    <img src="{{ current_user()->avatar }}" alt="{{ current_user()->username }}" class="object-cover h-full w-full filter hover:brightness-90 transition-all duration-200" >
                </a>
            </div>
            <div class="flex-auto">
                <div class="py-3">
                ...
                <div class="mt-2 flex justify-between items-center">
                    <div class="-ml-3 flex">
                        <a href="#" class="w-10 h-10 flex items-center justify-center rounded-full text-twitter hover:bg-twlightblue transition-colors duration-200">

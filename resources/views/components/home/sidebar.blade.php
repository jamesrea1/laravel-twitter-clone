    ...
    <div class="mb-4 overflow-hidden rounded-2xl bg-bluegray-50">
        ...
        <div class="border-t border-b border-gray-200 [ divide-y divide-gray-200 ]">
            ...
            @forelse ($whoToFollow as $user)
                <div class="flex px-4 py-3 items-center cursor-pointer hover:bg-twgray150 transition duration-200">
                    <div class="mr-3 flex-shrink-0">        
                        <a href="" class="block w-12 h-12 rounded-full overflow-hidden">
                    ...
                    <div class="flex-auto min-w-0 truncate">
                        <a href="" class="font-bold group">
                            <span class="group-hover:underline">{{ $user->name }}</span><br>
                            <span class="text-bluegray-500 font-normal">{{ '@'.$user->username }}</span>
                        </a>
                    </div>
                    <div class="flex-shrink-0 ml-1">
                        <a href="" class="inline-block px-3.5 py-1.5 rounded-full font-bold border border-gray-300 hover:bg-gray-300 transition duration-200">Follow</a>
                    </div>
                </div>
            @empty

        ...
        <div class="flex">
            <div class="mr-3 flex-shrink-0">
                <a href="{{ current_user()->path() }}">
                    <img src="{{ current_user()->avatar }}" alt="{{ current_user()->username }}" class="rounded-full block object-cover w-12 h-12" >
                </a>
            </div>
            <div class="flex-auto">
                <div class="py-3">
                ...
                <div class="mt-2 flex justify-between items-center">
                    ...
                    <div>
                        <button id="composeTweetSubmit" 
                            type="submit" 
                            class="block py-2 px-4 rounded-full text-white font-bold bg-twitter 

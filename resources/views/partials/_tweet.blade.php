<div class="flex px-4 pt-3 pb-1 cursor-pointer hover:bg-gray-50 transition-colors duration-200">
        ...
        <div class="flex justify-between w-11/12 mt-1 -ml-2.5">
            ...
            @if ($like = $tweet->getLikeBy(current_user()))
                <form action="/likes/{{ $like }} " method="POST">
                    ...
                    <button type="submit" class="inline-flex items-center group cursor-pointer text-twrose">
                        <div class="w-9 h-9 flex items-center justify-center rounded-full transition duration-200
                        ...
                        <span class="text-xs ml-1 mr-2 group-hover:text-twrose transition duration-200" style="min-width:20px">{{ $tweet->likes }} </span>
                    </button> 

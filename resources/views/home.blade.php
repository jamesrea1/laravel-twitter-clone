<x-layout.app>
    ...
    <x-slot name="sidebar">
        ...
        <div class="bg-white py-1 h-14 sticky top-0">
                ...
                <div class="border-t border-b border-gray-200 [ divide-y divide-gray-200 ]">
                    ...
                    <div class="flex px-4 py-3 items-center">
                        <div class="mr-1 flex-shrink-0">        
                            <a href="">
                                <img src="http://localhost:3000/images/default-avatar-2.jpeg" alt="james" class="rounded-full mr-2" width="50" height="50">
                            </a>
                        </div>
                        <div class="flex-auto min-w-0">
                            <a href="" class="font-bold block">
                                <div class="truncate">100daysofCode</div>
                                <div class="text-bluegray-500 font-normal truncate">@_100DaysOfCode</div>
                            </a>
                        </div>
